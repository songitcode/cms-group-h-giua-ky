...
?>
<form role="search" <?php echo $twentytwenty_aria_label; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped above. ?> method="get" class="search-form"
	...
	<label for="<?php echo esc_attr($twentytwenty_unique_id); ?>">
		...
		<input type="search" id="<?php echo esc_attr($twentytwenty_unique_id); ?>" class="search-field"
			placeholder="<?php echo esc_attr_x('Search topics or keywords', 'placeholder', 'twentytwenty'); ?>"
